...
# project name
override PROJECT = coremidi++

# main executable
override EXEC = exec_$(PROJECT)

# static library
override STATIC_LIBRARY = lib$(PROJECT).a

# shared library
override DYNAMIC_LIBRARY = lib$(PROJECT).dylib
...
all: ascii $(EXEC) $(STATIC_LIBRARY) $(DYNAMIC_LIBRARY) .WAIT $(COMPILE_DB)
...
fclean: clean
	$(RM) $(EXEC) $(STATIC_LIBRARY) $(DYNAMIC_LIBRARY)
